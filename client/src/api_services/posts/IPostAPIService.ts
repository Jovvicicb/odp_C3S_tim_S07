...
export interface IPostAPIService {
    ...
    getByUser(userId: number): Promise<ApiResponse<PostWithDetailsDto[]>>;
    ...
    getAllForAdmin(page: number, limit: number): Promise<ApiResponse<PaginatedListDto<PostWithDetailsDto>>>;
}