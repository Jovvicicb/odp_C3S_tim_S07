          ...
          <div className="mb-4 flex items-start justify-between gap-4">
            <div className="min-w-0">
              <p className="text-xs font-medium text-white/30">
                Post #{post.id} · Created {createdAt}
              </p>

              <h2 className="mt-2 line-clamp-2 text-xl font-semibold tracking-tight text-white transition-colors group-hover:text-sky-100">
                {post.title}
              </h2>
            </div>

            <div className="shrink-0 rounded-2xl border border-white/8 bg-white/4 px-3 py-2 text-xs font-semibold text-white/35">
              #{post.communityId}
            </div>
          </div>

          <p className="line-clamp-3 text-sm leading-7 text-white/45">
            {post.content}
          </p>
