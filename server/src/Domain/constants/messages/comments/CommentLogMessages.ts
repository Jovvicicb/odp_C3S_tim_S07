export const CommentLogMessages = {
  ...
  fetchByUserFailed: "Fetch comments by user failed",
  findByUserFailed: "Find comments by user failed",
  findUserCommentPostIdsFailed: "Find user comment post ids failed",
  } as const;